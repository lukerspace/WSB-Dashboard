...
async def get_stocks():
    ...
    async with pool.acquire() as connection:
        ...
        symbol_urls = {}
        for stock in stocks:
            symbol_urls[stock['id']] = f"https://api.polygon.io/v2/aggs/ticker/{stock['symbol']}/range/5/minute/2020-02-01/2020-06-15?apiKey={config.POLYGON_API_KEY}&limit=50000"
